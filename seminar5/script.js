...
// Задача 2 Необходимо из объекта, который лежит в константе post вывести значения, к которым приписан комментарий, в консоль.
...
//Задача 3 Дан массив products, необходимо цену каждого продукта уменьшить на 15% используя метод forEach.
...
// let newArr = products.filter(item => item.photos ? item.photos.length : undefined);
// console.log(newArr);
